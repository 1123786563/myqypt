...
- Gate 清单的**唯一权威**是 ADR-0057 的 13 项（2026-08-25 裁决 ADR-0044 与基线 §25 的分叉；Nacos Production PoC 移为 AI Registry 旁路转正门，不属于付费上线 P0）——T88 按 ADR-0057 清单聚合（ADR-0057 accepted 2026-08-25）。
